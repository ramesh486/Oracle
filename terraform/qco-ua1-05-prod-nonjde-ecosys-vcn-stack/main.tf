...
module "vcn_prod_nonjde" {
  ...
  vcn_display_name = var.ecosys_vcn_prod_nonjde_display_name
  vcn_dns_label    = var.ecosys_vcn_prod_nonjde_dns_label
  vcn_cidr_block   = var.ecosys_vcn_prod_nonjde_cidr_block
...
module "vcn_prod_nonjde_servicegateway_private" {
  ...
  servicegw_display_name = var.ecosys_vcn_prod_nonjde_servicegateway_private_display_name
}
...
module "vcn_prod_nonjde_drg_attachment" {
  ...
  oci_core_drg_attachment_display_name = var.ecosys_vcn_prod_nonjde_drg_attachment_display_name
}
...
module "vcn_prod_nonjde_to_prod_hub_lpg_attachment" {
  ...
  local_peering_gateway_display_name = var.prod_nonjde_ecosys_vcn_to_prod_hub_lpg_display_name
}
...
module "subnets" {
  ...
  definedTags                           = var.project_tag.definedTags
  freeformTags                          = var.project_tag.freeformTags
  vcn_subnet_display_name               = var.ecosys_sn_prod_nonjde_display_name
  vcn_subnet_dns_label                  = var.ecosys_sn_prod_nonjde_dns_label
  vcn_subnet_cidr_block                 = var.ecosys_sn_prod_nonjde_cidr_block
...
module "security_lists" {
  ...
  definedTags                = var.project_tag.definedTags
  freeformTags               = var.project_tag.freeformTags
  security_list_display_name = var.ecosys_vcn_prod_nonjde_securitylist_display_name
...
module "route_tables" {
  ...
  definedTags              = var.project_tag.definedTags
  freeformTags             = var.project_tag.freeformTags
  route_table_display_name = var.ecosys_vcn_prod_nonjde_routetable_private_display_name
  vcn_ocid                 = module.vcn_prod_nonjde.vcn_ocid
