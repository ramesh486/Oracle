...
variable "ecosys_sn_prod_nonjde_display_name" {
  ...
  default     = "qco-ua1-prod-ecosys-sn"
}
...
variable "ecosys_vcn_prod_nonjde_servicegateway_private_display_name" {
  ...
  default     = "qco-ua1-prod-nonjde-ecosys-servicegateway"
}
...
variable "ecosys_vcn_prod_nonjde_routetable_private_display_name" {
  ...
  default     = "qco-ua1-prod-nonjde-ecosys-private-rt"
}
...
variable "ecosys_vcn_prod_nonjde_drg_attachment_display_name" {
  ...
  default     = "qco-ua1-prod-nonjde-ecosys-vcn-drg-attachment"
}
...
variable "ecosys_vcn_prod_nonjde_securitylist_display_name" {
  ...
  default     = "qco-ua1-prod-nonjde-ecosys-sl"
}
...
variable "prod_nonjde_ecosys_vcn_to_prod_hub_lpg_display_name" {
  type        = string
  description = "Prod Non-JDE to Prod Hub LPG Display Name"
  default     = "qco-ua1-prod-nonjde-ecosys-vcn-to-prod-hub-vcn-lpg"
}

variable "prod_hub_vcn_to_prod_nonjde_ecosys_vcn_lpg_display_name" {
  type        = string
  description = "Peering Prod Hub VCN to Prod Non-JDE VCN LPG Display Name"
  default     = "qco-ua1-prod-hub-vcn-to-prod-nonjde-ecosys-vcn-lpg"
}
