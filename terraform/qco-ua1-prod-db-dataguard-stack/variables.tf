...
variable "sn_db_prod_display_name" {
  type = string
  default = "qco-ua1-prod-dbcs-client-sn"
  description = "The name of the subnet where the DB System is located"
}

variable "sn_sec_db_prod_display_name" {
  type = string
  default = "qco-ua1-prod-dbcs-client-sn"
  description = "The name of the subnet where the DB System is located"
}
