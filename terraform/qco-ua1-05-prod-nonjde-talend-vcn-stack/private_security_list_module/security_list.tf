resource "oci_core_security_list" "this" {
    ...
    dynamic "egress_security_rules" {
        ...
        content {
            ...
            dynamic "icmp_options" {
                for_each  = ( egress_security_rules.value.security_list_egress_security_rules_protocol == "1" && lookup(egress_security_rules.value, "security_list_egress_security_rules_icmp_options_type", null) != null ? [egress_security_rules.value] : [])
                content {
    ...
    dynamic "ingress_security_rules" {
        ...
        content {
            ...
            dynamic "icmp_options" {
                for_each  = ( ingress_security_rules.value.security_list_ingress_security_rules_protocol == "1" && lookup(ingress_security_rules.value, "security_list_ingress_security_rules_icmp_options_type", null) != null ? [ingress_security_rules.value] : [])
                content {
