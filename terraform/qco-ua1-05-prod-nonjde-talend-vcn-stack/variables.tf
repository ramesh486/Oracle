...
# ----------------------------------------
# Prod NONJDE TALEND VCN Variables
# ----------------------------------------

variable "talend_vcn_prod_nonjde_display_name" {
  type        = string
  description = "Prod NONJDE TALEND VCN Display Name"
  default     = "qco-ua1-prod-nonjde-talend-vcn"
}

variable "talend_vcn_prod_nonjde_dns_label" {
  type        = string
  description = "Prod NONJDE TALEND VCN DNS Label"
  default     = "prdnonjdetalendvcnua1"
}

variable "talend_vcn_prod_nonjde_cidr_block" {
  description = "Prod NONJDE TALEND VCN Cidr Block"
  type        = string
...
variable "talend_sn_prod_nonjde_display_name" {
  type        = string
  description = "Prod NONJDE Subnet Display Name"
  default     = "qco-ua1-prod-talend-sn"
}
...
variable "talend_vcn_prod_nonjde_servicegateway_private_display_name" {
  type        = string
  description = "Prod NONJDE VCN Service Gateway Display Name"
  default     = "qco-ua1-prod-nonjde-talend-servicegateway"
}
...
variable "talend_vcn_prod_nonjde_routetable_private_display_name" {
  type        = string
  description = "Prod NONJDE VCN Route Table"
  default     = "qco-ua1-prod-nonjde-talend-private-rt"
}
...
variable "talend_vcn_prod_nonjde_drg_attachment_display_name" {
  type        = string
  description = "Prod NONJDE DRG Attachment Display Name"
  default     = "qco-ua1-prod-nonjde-talend-vcn-drg-attachment"
}
...
variable "talend_vcn_prod_nonjde_securitylist_display_name" {
  type        = string
  description = "Prod NONJDE VCN Private Subnet Security List Display Name"
  default     = "qco-ua1-prod-nonjde-talend-sl"
}

variable "talend_vcn_prod_nonjde_securitylist_is_stateless" {
  type        = bool
  description = "Prod NONJDE VCN Private Subnet Security List is Stateless?"
  default     = false
}

variable "prod_nonjde_talend_vcn_to_prod_hub_lpg_display_name" {
  type        = string
  description = "Prod Non-JDE to Prod Hub LPG Display Name"
  default     = "qco-ua1-prod-nonjde-talend-vcn-to-prod-hub-vcn-lpg"
}

variable "prod_hub_vcn_to_prod_nonjde_talend_vcn_lpg_display_name" {
  type        = string
  description = "Peering Prod Hub VCN to Prod Non-JDE VCN LPG Display Name"
  default     = "qco-ua1-prod-hub-vcn-to-prod-nonjde-talend-vcn-lpg"
}
