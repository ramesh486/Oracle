  ...
  vcn_nonjde_destination_security_rules = [
    {
      ...
      "security_list_egress_security_rules_stateless"        = var.oem_vcn_nonjde_securitylist_is_stateless
    }
  ]

  vcn_nonjde_source_security_rules = [
    {
      "security_list_ingress_security_rules_source"      = var.oem_vcn_nonjde_cidr_block
      ...
      "security_list_ingress_security_rules_stateless"   = var.oem_vcn_nonjde_securitylist_is_stateless
    }
  ]
