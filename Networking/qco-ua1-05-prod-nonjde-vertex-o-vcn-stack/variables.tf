...
# ----------------------------------------
# Prod NONJDE VERTEX O VCN Variables
# ----------------------------------------

variable "vertex_o_vcn_prod_nonjde_display_name" {
  type        = string
  description = "Prod NONJDE VERTEX O VCN Display Name"
  default     = "qco-uas1-prod-nonjde-vertex-o-vcn"
}

variable "vertex_o_vcn_prod_nonjde_dns_label" {
  type        = string
  description = "Prod NONJDE VERTEX O VCN DNS Label"
  default     = "prdnonjdevertexovcnuas1"
}

variable "vertex_o_vcn_prod_nonjde_cidr_block" {
  description = "Prod NONJDE VERTEX O VCN Cidr Block"
  type        = string
  default     = "10.241.42.128/25"
}
...
variable "vertex_o_sn_prod_nonjde_display_name" {
  type        = string
  description = "Prod NONJDE Subnet Display Name"
  default     = "qco-uas1-prod-nonjde-vertex-o-sn"
}

variable "vertex_o_sn_prod_nonjde_dns_label" {
  type        = string
  description = "Prod NONJDE Subnet DNS Label"
  default     = "vertexosn"
}

variable "vertex_o_sn_prod_nonjde_cidr_block" {
  type        = string
  description = "Prod NONJDE Subnet Cidr Block"
  default     = "10.241.42.128/26"
}
...
variable "vertex_o_vcn_prod_nonjde_servicegateway_private_display_name" {
  type        = string
  description = "Prod NONJDE VCN Service Gateway Display Name"
  default     = "qco-uas1-prod-nonjde-vertex-o-servicegateway"
}
...
variable "vertex_o_vcn_prod_nonjde_routetable_private_display_name" {
  type        = string
  description = "Prod NONJDE VCN Route Table"
  default     = "qco-uas1-prod-nonjde-vertex-o-private-rt"
}
...
variable "vertex_o_vcn_prod_nonjde_drg_attachment_display_name" {
  type        = string
  description = "Prod NONJDE DRG Attachment Display Name"
  default     = "qco-uas1-prod-nonjde-vertex-o-vcn-drg-attachment"
}
...
variable "vertex_o_vcn_prod_nonjde_securitylist_display_name" {
  type        = string
  description = "Prod NONJDE VCN Private Subnet Security List Display Name"
  default     = "qco-uas1-prod-nonjde-vertex-o-sl"
}

variable "vertex_o_vcn_prod_nonjde_securitylist_is_stateless" {
  type        = bool
