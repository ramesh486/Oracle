  ...
  vcn_prod_nonjde_destination_security_rules = [
    {
      ...
      "security_list_egress_security_rules_stateless"        = var.hyperion_ipm_vcn_prod_nonjde_securitylist_is_stateless
    }
  ]

  vcn_prod_nonjde_source_security_rules = [
    {
      "security_list_ingress_security_rules_source"      = var.hyperion_ipm_vcn_prod_nonjde_cidr_block
      ...
      "security_list_ingress_security_rules_stateless"   = var.hyperion_ipm_vcn_prod_nonjde_securitylist_is_stateless
    }
  ]
